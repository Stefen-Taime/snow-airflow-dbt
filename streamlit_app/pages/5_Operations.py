...
# ── Data ─────────────────────────────────────────────────────────
df_hourly = run_query("SELECT * FROM ANALYTICS.PUBLIC_OPERATIONS.MET_HOURLY_DEMAND ORDER BY TRIP_DATE, PICKUP_HOUR")
df_dur = run_query("SELECT * FROM ANALYTICS.PUBLIC_OPERATIONS.MET_TRIP_DURATION_DIST ORDER BY TRIP_MONTH")
df_speed = run_query("SELECT * FROM ANALYTICS.PUBLIC_OPERATIONS.MET_AVG_SPEED_TREND ORDER BY TRIP_DATE")
df_vendor = run_query("SELECT * FROM ANALYTICS.PUBLIC_OPERATIONS.MET_VENDOR_PERFORMANCE ORDER BY TRIP_MONTH")
