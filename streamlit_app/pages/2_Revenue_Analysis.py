...
# ── Data ─────────────────────────────────────────────────────────
df_daily = run_query("SELECT * FROM ANALYTICS.PUBLIC_REVENUE.MET_DAILY_REVENUE ORDER BY TRIP_DATE")
df_zone = run_query("SELECT * FROM ANALYTICS.PUBLIC_REVENUE.MET_REVENUE_BY_ZONE ORDER BY TOTAL_REVENUE DESC")
df_rate = run_query("SELECT * FROM ANALYTICS.PUBLIC_REVENUE.MET_REVENUE_BY_RATE_CODE ORDER BY TRIP_MONTH")
df_pay = run_query("SELECT * FROM ANALYTICS.PUBLIC_REVENUE.MET_PAYMENT_DISTRIBUTION ORDER BY TRIP_MONTH")
